...
public class BookServiceImpl implements BookService {
    ...
    public void deleteTheBookFromLibrary(Long id, String id_library) {
        ...
        // this.bookRepository.getById(id).getLibraries().remove(id_library);
        ...
        //this.bookRepository.deleteBookByLibraries(library);
        //.removeIf(library1 -> library1.equals(library));

    }

    /*@Override
    public void deleteBookByLibrariesThatIsIn(Library library) {
        this.bookRepository.deleteBookByLibraries(library);
    }*/
